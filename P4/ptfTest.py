...
fp_ports = ["28/0", "16/0", "17/0", "18/0", "19/0","21/0","22/0","23/0","24/0"]
        ...
        try:
            ...
            if test_param_get('setup') == True or (test_param_get('setup') != True
                ...
                for i in self.devPorts:
                    if int(i) in [999]: #pal_port_speed_t.BF_SPEED_40G, pal_fec_type_t.BF_FEC_TYP_NONE
                        self.pal.pal_port_add(0, i,
                                            pal_port_speed_t.BF_SPEED_40G, pal_fec_type_t.BF_FEC_TYP_NONE) #pal_fec_type_t.BF_FEC_TYP_REED_SOLOMON
                        self.pal.pal_port_an_set(0, i, 2);
                        self.pal.pal_port_enable(0, i)
                    else:
                        self.pal.pal_port_add(0, i,
                                            pal_port_speed_t.BF_SPEED_100G, pal_fec_type_t.BF_FEC_TYP_REED_SOLOMON) #pal_fec_type_t.BF_FEC_TYP_REED_SOLOMON
                        self.pal.pal_port_an_set(0, i, 2);
                        self.pal.pal_port_enable(0, i)
